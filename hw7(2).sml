...
fun eval_prog (e,env) =
	...
	(case List.find (fn (s2,v) => s=s2) env of
      ...
      | Shift(deltax, deltay, sube) => case sube of
					   NoPoints => sube
					 ...
					 | Shift(deltax, deltay, sube) => eval_prog(Shift(deltax, deltay, eval_prog(Shift(deltax, deltay, sube), env)), env)
...
fun preprocess_prog (e) =
	...
	NoPoints => e
      ...
      | Shift(deltax, deltay, sube) => Shift(deltax, deltay, preprocess_prog(sube))
